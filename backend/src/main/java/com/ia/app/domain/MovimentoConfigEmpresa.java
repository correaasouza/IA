...
@Entity
@Table(
  name = "movimento_config_empresa",
  uniqueConstraints = {
    @UniqueConstraint(
      name = "ux_movimento_config_empresa_scope",
      columnNames = {"tenant_id", "movimento_config_id", "empresa_id"})
  })
public class MovimentoConfigEmpresa extends AuditableEntity {
