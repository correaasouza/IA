...
import com.ia.app.service.ConfigFormularioService;
...
@RestController
@RequestMapping("/api/config/formularios")
public class ConfigFormularioController {

  private final ConfigFormularioService service;

  public ConfigFormularioController(ConfigFormularioService service) {
